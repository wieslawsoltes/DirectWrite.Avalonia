...
namespace Avalonia.Direct2D1.Media
{
    ...
    internal class WicBitmapImpl : BitmapImpl, IReadableBitmapImpl
    {
        ...
        public APixelFormat PixelFormat { get; private set; } = APixelFormat.Bgra8888;

        public AlphaFormat AlphaFormat { get; private set; } = Platform.AlphaFormat.Premul;
        ...
        class LockedBitmap : ILockedFramebuffer
        {
            ...
            public AlphaFormat AlphaFormat => _parent.AlphaFormat;
        ...
        public ILockedFramebuffer Lock() =>
            new LockedBitmap(this, WicImpl.Lock(BitmapLockFlags.Write), PixelFormat);
    }
}
